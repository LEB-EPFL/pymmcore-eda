...
def events_with_sequence(eda_sequence):
    ...
    event1 = EDAEvent(min_start_time=0.0, channel=Channel(config="DAPI"), z_pos=0.0, sequence=eda_sequence)
    event2 = EDAEvent(min_start_time=0.0, channel=Channel(config="GFP"), z_pos=0.0, sequence=eda_sequence)
    event3 = EDAEvent(min_start_time=0.0, channel=Channel(config="TRITC"), z_pos=0.0, sequence=eda_sequence)
    event4 = EDAEvent(min_start_time=0.0, channel=Channel(config="Cy5"), z_pos=0.0, sequence=eda_sequence)
...
def test_channel_not_in_sequence():
    ...
    event4 = EDAEvent(min_start_time=0.0, channel=Channel(config="Cy5"), sequence=seq)  # Not in sequence
